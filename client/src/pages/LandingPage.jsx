...
// const LandingPage = () => {
//   return (
//     <div className="min-h-screen bg-[#1A0F0A] text-white overflow-hidden">
//       {/* Animated Background Gradient - Warm Amber & Rose */}
//       <div className="fixed inset-0 overflow-hidden pointer-events-none">
//         <div className="absolute -top-40 -right-40 w-80 h-80 bg-amber-500/20 rounded-full blur-3xl animate-pulse" />
//         <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-rose-500/20 rounded-full blur-3xl animate-pulse delay-1000" />
...
//       animate={{ y: 0 }}
//       transition={{ duration: 0.5 }}
//       className="sticky top-0 z-50 backdrop-blur-xl bg-[#1A0F0A]/80 border-b border-white/5"
//     >
//       <div className="px-6 md:px-20 py-4">
//         <div className="flex items-center justify-between">
//           {/* Logo - Amber to Rose gradient */}
//           <motion.div 
//             whileHover={{ scale: 1.05 }}
//             className="text-2xl font-bold bg-gradient-to-r from-amber-400 to-rose-400 bg-clip-text text-transparent"
//           >
//             CollabSphere
//           </motion.div>
...
//           {/* CTA Button - Amber to Rose */}
//           <motion.button
//             whileHover={{ scale: 1.05 }}
//             whileTap={{ scale: 0.95 }}
//             className="px-6 py-2 bg-gradient-to-r from-amber-500 to-rose-500 rounded-xl font-medium text-white shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 transition-all"
//           >
//             Get Matched
//           </motion.button>
//         </div>
...
//             whileTap={{ scale: 0.95 }}
//             className="px-8 py-4 bg-gradient-to-r from-amber-500 to-rose-500 rounded-xl font-semibold text-lg flex items-center justify-center gap-2 group"
//           >
//             Get Matched
//             <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
//           </motion.button>
...
//               transition={{ delay: index * 0.1 }}
//               whileHover={{ y: -5 }}
//               className="p-8 rounded-2xl bg-gradient-to-b from-white/5 to-white/0 border border-white/10 backdrop-blur-sm hover:shadow-xl hover:shadow-amber-500/10 transition-all"
//             >
//               <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500 to-rose-500 p-3 mb-4">
//                 {problem.icon}
//               </div>
//               <h3 className="text-xl font-semibold mb-3">{problem.title}</h3>
//               <p className="text-gray-400">{problem.description}</p>
...
// // Features Section with warm gradients
// const Features = () => {
//   const features = [
//     {
//       icon: <Brain className="w-6 h-6" />,
...
//         <div className="relative">
//           {/* Connecting Line */}
//           <div className="absolute top-1/2 left-0 w-full h-0.5 bg-gradient-to-r from-amber-500 to-rose-500 hidden lg:block opacity-30" />
...
//                 className="relative text-center"
//               >
//                 <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-amber-500 to-rose-500 mb-6 relative z-10">
//                   {step.icon}
//                 </div>
//                 <div className="text-2xl font-bold text-gray-600 mb-2">{step.number}</div>
//                 <h3 className="text-xl font-semibold mb-2">{step.title}</h3>
...
//         <motion.div
//           whileHover={{ scale: 1.02 }}
//           className="p-8 rounded-3xl bg-gradient-to-br from-amber-500/10 to-rose-500/10 border border-white/10 backdrop-blur-xl shadow-2xl"
//         >
//           <div className="flex items-start gap-6">
//             {/* Avatar */}
//             <div className="relative">
//               <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-amber-500 to-rose-500 flex items-center justify-center text-2xl font-bold">
//                 JD
//               </div>
//               <div className="absolute -bottom-2 -right-2 w-6 h-6 rounded-full bg-amber-500 border-4 border-[#1A0F0A]" />
//             </div>
...
//               <div className="flex items-center gap-3 mb-4">
//                 <h3 className="text-2xl font-bold">John Doe</h3>
//                 <span className="px-3 py-1 rounded-full bg-gradient-to-r from-amber-500 to-rose-500 text-xs font-semibold">
//                   Strong Complement
//                 </span>
//               </div>
...
//         whileInView={{ opacity: 1, scale: 1 }}
//         viewport={{ once: true }}
//         className="max-w-4xl mx-auto text-center p-12 md:p-16 rounded-3xl bg-gradient-to-br from-amber-500/20 to-rose-500/20 border border-white/10 backdrop-blur-xl relative overflow-hidden"
//       >
//         {/* Animated background elements */}
//         <div className="absolute inset-0" style={{
//           backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.05) 1px, transparent 1px),
...
//           whileTap={{ scale: 0.95 }}
//           className="px-8 md:px-12 py-4 md:py-5 bg-gradient-to-r from-amber-500 to-rose-500 rounded-xl font-bold text-lg md:text-xl flex items-center gap-3 mx-auto group"
//         >
//           Start Building Now
//           <ArrowRight className="w-5 h-5 md:w-6 md:h-6 group-hover:translate-x-2 transition-transform" />
//         </motion.button>
